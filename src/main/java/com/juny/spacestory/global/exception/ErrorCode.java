...
public enum ErrorCode {
  ...
  USER_INVALID_EMAIL(
    HttpStatus.BAD_REQUEST, Const.USER_EMAIL_INVALID_CODE, Const.USER_EMAIL_INVALID_MSG),
  USER_INVALID_PHONE_NUMBER(
    HttpStatus.BAD_REQUEST, Const.USER_PHONE_NUMBER_INVALID_CODE, Const.USER_PHONE_NUMBER_INVALID_MSG),

  UserPasswordIsShort(
    HttpStatus.BAD_REQUEST, Const.USER_PASSWORD_IS_SHORT_CODE, Const.USER_PASSWORD_IS_SHORT_MSG),

  ACCESS_TOKEN_EXPIRED(
    HttpStatus.UNAUTHORIZED, Const.ACCESS_TOKEN_EXPIRED_CODE, Const.ACCESS_TOKEN_EXPIRED_MSG),
  ACCESS_TOKEN_INVALID(
    HttpStatus.UNAUTHORIZED, Const.ACCESS_TOKEN_INVALID_CODE, Const.ACCESS_TOKEN_INVALID_MSG),
  REFRESH_TOKEN_INVALID(
    HttpStatus.UNAUTHORIZED, Const.REFRESH_TOKEN_INVALID_CODE, Const.REFRESH_TOKEN_INVALID_MSG),
