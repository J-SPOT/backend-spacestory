...
public enum ErrorCode {
  ...
  ACCESS_TOKEN_EXPIRED(
      HttpStatus.BAD_REQUEST, Const.ACCESS_TOKEN_EXPIRED_CODE, Const.ACCESS_TOKEN_EXPIRED_MSG),
  ACCESS_TOKEN_INVALID(
      HttpStatus.BAD_REQUEST, Const.ACCESS_TOKEN_INVALID_CODE, Const.ACCESS_TOKEN_INVALID_MSG),
  REFRESH_TOKEN_INVALID(
      HttpStatus.BAD_REQUEST, Const.REFRESH_TOKEN_INVALID_CODE, Const.ACCESS_TOKEN_INVALID_MSG),
  ;
