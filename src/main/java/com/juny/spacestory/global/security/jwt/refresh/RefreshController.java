...
public class RefreshController {
  ...
  @Operation(
    ...
    description = "{도메인}/social_login_handler?social_login=success 리다이렉트하여 핸들러를 호출할 수 있는 URL을 제공합니다.<br>서버는 쿠키에 임시 RefreshToken을 발급한 상태입니다. 해당 API를 호출하여 쿠키를 검증하고, 유효하다면 응답메시지에 액세스 토큰과 리프레시 토큰을 새로 발급합니다. 기존 쿠키는 삭제합니다.")
  @ApiResponses(
    value = {
