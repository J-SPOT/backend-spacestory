...
//              EnumSet.of(DetailedType.PARTY_ROOM, DetailedType.RESIDENCE, DetailedType.CAFE),
//          SpaceType.EVENT,
//              EnumSet.of(
//                  DetailedType.PERFORMANCE_VENUE,
//                  DetailedType.CONFERENCE_HALL,
//                  DetailedType.EXHIBITION_HALL),
//          SpaceType.EDUCATION,
//              EnumSet.of(
//                  DetailedType.STUDY_ROOM,
//                  DetailedType.LECTURE_ROOM,
//                  DetailedType.SEMINAR_ROOM,
//                  DetailedType.MEETING_ROOM),
//          SpaceType.ART,
//              EnumSet.of(
//                  DetailedType.DANCE_ROOM,
//                  DetailedType.VOCAL_ROOM,
//                  DetailedType.INSTRUMENT_ROOM,
//                  DetailedType.DRAWING_ROOM,
//                  DetailedType.CRAFT_ROOM),
//          SpaceType.SPORT,
//              EnumSet.of(
//                  DetailedType.BADMINTON_COURT,
//                  DetailedType.FUTSAL_COURT,
//                  DetailedType.TENNIS_COURT),
...
//  private final SpaceMapper mapper;
//
//  public Page<ResSpaces> searchByTypeInSeoul(SpaceType spaceType, int page, int size) {
//    PageRequest pageRequest = PageRequest.of(page, size);
//
//    Page<Space> spaces = spaceRepository.findBySpaceTypeInSeoulQuerydsl(
//      spaceType, pageRequest);
//
//    return mapper.toResSpaces(spaces);
//  }
//
//  public Page<ResSpaces> searchSpaces(
//      SpaceType spaceType,
//      String sido,
//      String sigungu,
//      int minCapacity,
//      Set<DetailedType> detailedType,
//      int page,
//      int size) {
//    PageRequest pageRequest = PageRequest.of(page, size);
//
//    Page<Space> spaces = spaceRepository.findByCriteriaQuerydsl(
//      spaceType, sido, sigungu, minCapacity, detailedType, pageRequest);
//    return mapper.toResSpaces(spaces);
//  }
//
//  public ResSpaces create(RequestCreateSpace req) {
...
//        realEstateRepository.findByAddress_RoadAddress(req.roadAddress()).orElse(null);
//    if (findRealEstate == null) {
//      Address address =
//          new Address(req.roadAddress(), req.jibunAddress(), req.sido(), req.sigungu(), req.dong());
...
//    Set<DetailedType> validDetailedTypes =
//        validDetailedTypesMap.getOrDefault(spaceType, EnumSet.noneOf(DetailedType.class));
//    return !validDetailedTypes.containsAll(detailedTypes);
//  }
//
//  public ResSpaces update(Long spaceId, RequestUpdateSpace req) {
//    if (isInValidDetailedTypes(req.spaceType(), req.detailedTypes())) {
//      throw new SpaceInvalidDetailedTypeBusinessException(ErrorCode.SPACE_INVALID_DETAILED_TYPE);
//    }
