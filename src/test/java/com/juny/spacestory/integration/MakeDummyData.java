...
public class MakeDummyData {
  ...
  void HostAndRealEstateAndSpace() {
    ...
    for (int i = st; i <= n; ++i) {
      ...
      // Host
      User host = new User("host" + i, "host" + i + "@gmail.com", passwordEncoder.encode("1234"),
        "172.21.0.3");
      ...
      Space spaceA = new Space("spaceA " + i, "desc" + i, "notes" + i, openingTime, closingTime,
        hourlyRate, spaceSize,
        maxCapacity);

      Space spaceB = new Space("spaceB " + i, "desc" + i, "notes" + i, openingTime, closingTime,
        hourlyRate, spaceSize,
        maxCapacity);
...
//            reservationRepository.save(spaceReservation3);
  ...
  @Test
  void setOptions() {
//    Option option1 = new Option("TV/프로젝터");
//    Option option2 = new Option("인터넷/WIFI");
//    Option option3 = new Option("복사/인쇄기");
//    Option option4 = new Option("화이트보드");
//    Option option5 = new Option("음향/마이크");
//
...
//    MainCategory mainCategory1 = new MainCategory("모임");
//    mainCategoryRepository.save(mainCategory1);
//
//    MainCategory mainCategory2 = new MainCategory("연습");
//    mainCategoryRepository.save(mainCategory2);
//
//    MainCategory mainCategory3 = new MainCategory("촬영");
//    mainCategoryRepository.save(mainCategory3);
//
//    MainCategory mainCategory4 = new MainCategory("행사");
//    mainCategoryRepository.save(mainCategory4);
//
//    MainCategory mainCategory5 = new MainCategory("오피스");
//    mainCategoryRepository.save(mainCategory5);
//
//    SubCategory subCategory1 = new SubCategory("파티룸");
//    subCategory1.setMainCategory(mainCategory1);
//    subCategoryRepository.save(subCategory1);
//
//    SubCategory subCategory2 = new SubCategory("스터디룸");
//    subCategory2.setMainCategory(mainCategory1);
//    subCategoryRepository.save(subCategory2);
//
//    SubCategory subCategory3 = new SubCategory("공유주방");
//    subCategory3.setMainCategory(mainCategory1);
//    subCategoryRepository.save(subCategory3);
//
//    SubCategory subCategory4 = new SubCategory("연습실");
//    subCategory4.setMainCategory(mainCategory2);
//    subCategoryRepository.save(subCategory4);
//
//    SubCategory subCategory5 = new SubCategory("댄스연습실");
//    subCategory5.setMainCategory(mainCategory2);
//    subCategoryRepository.save(subCategory5);
//
//    SubCategory subCategory6 = new SubCategory("보컬연습실");
//    subCategory6.setMainCategory(mainCategory2);
//    subCategoryRepository.save(subCategory6);
//
//
//    SubCategory subCategory7 = new SubCategory("촬영스튜디오");
//    subCategory7.setMainCategory(mainCategory3);
//    subCategoryRepository.save(subCategory7);
//
//    SubCategory subCategory8 = new SubCategory("렌탈스튜디오");
//    subCategory8.setMainCategory(mainCategory3);
//    subCategoryRepository.save(subCategory8);
//
//    SubCategory subCategory9 = new SubCategory("공연장");
//    subCategory9.setMainCategory(mainCategory4);
//    subCategoryRepository.save(subCategory9);
//
//    SubCategory subCategory10 = new SubCategory("컨퍼런스");
//    subCategory10.setMainCategory(mainCategory4);
//    subCategoryRepository.save(subCategory10);
//
//    SubCategory subCategory11 = new SubCategory("독립오피스");
//    subCategory11.setMainCategory(mainCategory5);
//    subCategoryRepository.save(subCategory11);
//
//    SubCategory subCategory12 = new SubCategory("코워킹오피스");
